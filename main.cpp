...
{int mayor=arreglo[0];for(int z=0; z<tamano; z++){if (mayor< arreglo [z]) mayor=arreglo[z];}return mayor;}

//Devuelve el numero menor del arreglo (dado) que contiene tamano (dado) elementos
int getMenor(int arreglo[], int tamano)
{int menor=arreglo[0];for(int z=0; z<tamano; z++){if (menor> arreglo [z])menor=arreglo[z];}return menor;}
...
{int suma=0;int promedio=0;int total;for (int a=0; a<tamano; a++){suma+=arreglo[a];total=tamano;promedio=suma/total;}return promedio;}
